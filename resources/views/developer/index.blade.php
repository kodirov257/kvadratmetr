...
{{--                     <img src="assets/img/NRG-logo.svg" alt="" />--}}
                  ...
                  <div class="developer-bar__title">{{$developer->name_uz}}</div>
                  <a href="{{route('cabinet.developer.edit')}}" class="developer-bar__button"
                  ...
                  <div class="contact__accounting">
                     <div class="contact__address">
                        ...
                        <div class="contact__social-address">
                           ...
                           <input class="social__phone-number" value="+998 (97) 740-23-99"/>
                        </div>
                     </div>
                     <div class="contact__address">
                        ...
                        <div class="contact__social-address">
                           ...
                           <input class="social__phone-number" value="https://www.u-nrg.uz/"/>
                        </div>
                     </div>
                     <div class="contact__address">
