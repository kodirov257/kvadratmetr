...
@section('content')
    ...
    <div class="main-content">
        <div class="row">
            <div class="col-8">
                <div class="card">
                    <form  method="PUT" action="{{route('cabinet.developer.store', $user)}}">

                        <div class="developer-bar">
                            <div class="developer-bar__image">
                                <img src="{{asset('assets/img/NRG-oybek-logo.svg')}}" alt=""/>
                            </div>
                            <div class="developer-bar__title" id="titleMain">NRG Oybek</div>
                        ...
                        <div id="location" class="b-tab">
                            ...
                            <div class="location-address">
                                ...
                                <input class="location__office-address"
        ...
        function activateInput(type){
            switch (type){
                case 'title':
                    ...
                    document.getElementById('titleInput').style = ['display:show']
                    console.log('test');
                    break
                default:
                    console.log('default');
