...
@section('content')
    ...
    <section class="blog">
        <div class="container">
            <div class="blog-box">
                <h3 class="page-title dblint">See how <img src="assets/img/logo.svg" alt="Kvadrat metr logo"> can help
                </h3>
                <h3 class="page-title dblint-sec">See how <img src="assets/img/logo-small.svg" alt="Kvadrat metr logo">
                    can help</h3>
                <div class="row">
