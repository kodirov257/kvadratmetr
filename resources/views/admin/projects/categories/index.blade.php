...
@section('content')
    ...
    <p><a href="{{ route('admin.projects.categories.create') }}" class="btn btn-success">Add Category</a></p>
        ...
        @foreach ($categories as $category)
            <tr>
                <td>
                    ...
                    <a href="{{ route('admin.projects.categories.show', $category) }}">{{ $category->name }}</a>
                </td>
                <td>{{ $category->slug }}</td>
                <td>
                    <div class="d-flex flex-row">
                        ...
                        <form method="POST" action="{{ route('admin.projects.categories.down', $category) }}" class="mr-1">
                            @csrf
