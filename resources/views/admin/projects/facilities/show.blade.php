...
@section('content')
    <div class="d-flex flex-row mb-3">
        <a href="{{ route('admin.projects.facilities.edit', $facility) }}" class="btn btn-primary mr-1">{{ trans('adminlte.edit') }}</a>
        <form method="POST" action="{{ route('admin.projects.facilities.destroy', $facility) }}" class="mr-1">
            @csrf
            @method('DELETE')
