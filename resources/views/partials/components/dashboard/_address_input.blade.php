<div class="b-nav">
    <a href="#locationTab" data-tab-loc="locationTab" class="b-nav-tab active locations__info active">Location Info</a>
    <a href="#mapTab" data-tab-loc="mapTab" class="b-nav-tab locations__info">Map</a>
</div>

<div id="locationTab" class="b-tab active">
